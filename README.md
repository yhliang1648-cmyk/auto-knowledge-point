...
本平台整合了**七大創新教育項目**，為香港學生和教師提供全方位的AI學習與教學體驗：
...
| 特性 | DSE RAG | 斯坦福課程 | AI創客 | 認知探索者 | 刷題助手 | 教材評估 | API測試 |
|------|---------|-----------|--------|-----------|---------|---------|---------|
| **目標用戶** | DSE考生 | 中小學生 | 中小學生 | 中學生-大學生 | 所有學生 | 教師 | 開發者 |
| **課程時長** | 按需 | 8-16週 | 12週 | 55-67學時 | 隨時 | 按需 | 按需 |
| **學習方式** | 智能檢索 | 理論+實踐 | PBL | 沉浸式體驗 | 拍照批改 | 上傳評估 | API測試 |
| **技術難度** | 使用系統 | 中-高 | 低-中 | 中 | 使用系統 | 使用系統 | 開發工具 |
| **成果展示** | - | 作品集+證書 | 3-5個應用 | 認知博物館 | 成績提升 | 評估報告 | API狀態 |
| **特色** | RAG技術 | 斯坦福標準 | 炫酷遊戲化 | AI歷史對話 | OCR+AI批改 | AI智能評估 | 實時測試 |
| **平台** | Web | Web | Web | Web | **Web+App** | Web | Web |
...
├── textbook-eval.html               # 教材試卷評估系統 (新)
├── api-tester.html                  # API測試系統 (新)
